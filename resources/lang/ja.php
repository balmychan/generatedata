...
$L["install"] = "インストール";
$L["host_name"] = "ホスト名";
$L["installation"] = "インストール";
$L["table_prefix"] = "Table Prefix";
$L["database_name"] = "データベース名";
$L["mysql_username"] = "MySQL ユーザー名";
$L["mysql_password"] = "MySQL パスワード";
$L["default_language"] = "言語";
$L["installation_intro"] = "インストールを行います。まずここでは、データベースのテーブルを作成するために、データベース情報を入力します。これらのフィールドについて不明な点があれば、[ヘルプ]タブをクリックしてください。";
$L["version"] = "Version";
...
$L["user_account"] = "ユーザー情報";
$L["user_accounts"] = "ユーザー管理";
$L["password"] = "パスワード";
$L["reenter_password"] = "Re-enter password";
$L["email"] = "メールアドレス";
$L["yes"] = "はい";
$L["no"] = "いいえ";
$L["validation_no_db_hostname"] = "ホスト名を入力してください";
$L["validation_no_db_name"] = "データベース名を入力してください";
$L["validation_invalid_chars"] = "半角英数字、アンダースコアのみを入力してください";
$L["validation_no_mysql_username"] = "MySQLユーザー名を入力してください";
$L["validation_no_email"] = "メールアドレスを入力してください";
$L["validation_invalid_email"] = "メールアドレス形式で入力してください";
$L["validation_no_first_name"] = "名を入力してください";
$L["validation_no_last_name"] = "姓を入力してください";
$L["validation_no_password"] = "パスワードを入力してください";
$L["install_invalid_db_info"] = "データベースの接続に失敗しました。あなたの入力した情報が間違っている可能性があります。エラーメッセージ： <i>{\$db_connection_error}</i>";
...
$L["continue_rightarrow"] = "続ける &raquo;";
$L["check_database_info"] = "データベース情報の入力";
$L["create_settings_file"] = "設定ファイルの作成";
$L["complete_excl"] = "完了！";
$L["installation_step2_intro"] = "settings.phpファイルが見つかりませんでした。settings.phpファイルを作成するには、以下のボタンをクリックしてください。このファイルは、アプリケーションのルートフォルダに格納され、インストールに関するカスタム情報を格納する（データベース以外の）唯一の場所です";
...
$L["installation_step3_intro"] = "ユーザーの管理方法を、次の3つのうちから選んでください";
$L["single_anonymous_user_account"] = "シングルユーザー管理で、ログインせずにアクセスが可能";
$L["single_user_account_requires_login"] = "シングルユーザー管理で、ログインしてアクセスする";
$L["multiple_accounts"] = "マルチユーザー管理";
$L["goto_script_rightarrow"] = "Go to script &raquo;";
$L["enter_user_account_details"] = "ユーザー情報を入力してください";
...
$L["admin_account"] = "管理者アカウント";
$L["feature_enabled"] = "有効";
$L["anonymous_access"] = "匿名アクセス";
$L["anonymous_user_desc"] = "匿名ユーザーはスクリプトを使用できますが、一部制限があります。匿名ユーザーは一度に100行以上、データ・セットを保存したり生成することができません";
$L["anonymous_user_message"] = "匿名ユーザーに、下記のメッセージを表示します";
$L["anonymous_user_default_message"] = "ログインするか、または someone@yoursite.com に連絡し、アカウントを取得してください";
